...
Any alive cells will die if there are less than two neighouring alive cells.
### Rule 2: *Survival*
Any alive cells will live if there are two or three neighouring alive cells.
### Rule 3: *Overpopulation*
Any alive cells will die if there are more than three neighouring alive cells.
### Rule 4: *Reproduction*
